...
all: arcadia basic standard fracas kingdoms poon bushido
...
all-clean: arcadia-clean basic-clean standard-clean fracas-clean \
	kingdoms-clean poon-clean bushido-clean
...
poon-clean:
	$(MAKE) GAME=poon clean

bushido-clean:
	$(MAKE) GAME=bushido clean
...
poon-rules:
	$(MAKE) GAME=poon rules

bushido-rules:
	$(MAKE) GAME=bushido rules
