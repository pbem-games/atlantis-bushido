...
class SkillType
{
 public:
	...
	NOTEACH=0x2000,
	NOEXP=0x4000,
	PASSIVE_COMBAT=0x8000,
	S_BUSHIDO_KUGE=0x100000,
	S_BUSHIDO_SAMURAI=0x200000,
	S_BUSHIDO_NINJA=0x400000,
	S_BUSHIDO_GEISHA=0x800000,
	S_BUSHIDO_SORCEROR=0x1000000,
	S_BUSHIDO_PRIEST=0x2000000,
	S_BUSHIDO_MERCHANT=0x4000000,
	S_BUSHIDO_ARTISAN=0x8000000,
    };
    int flags;
