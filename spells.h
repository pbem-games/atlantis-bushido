...
//BUSHDIO mods
void ProcessHawking(Unit *,AString *, OrdersCheck *pCheck );
void ProcessSummonDemon(Unit *,AString *, OrdersCheck *pCheck );
void ProcessSummonUndead(Unit *,AString *, OrdersCheck *pCheck );
void ProcessSummonSpirit(Unit *,AString *, OrdersCheck *pCheck );
...
//BUSHIDO mods
int RunHawking(ARegion *,Unit *);
int RunCamouflage(ARegion *,Unit *);
int RunKeenEyes(ARegion *,Unit *);
int RunSummonUndead(ARegion *,Unit *);
int RunSummonSpirit(ARegion *,Unit *);
int RunSummonDragon(ARegion *,Unit *);

int CheckTeaCeremonyBuilding(Unit *);
#endif
