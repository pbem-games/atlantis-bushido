...
void Game::CreateWorld()
{
  ...
  regions.CreateLevels(2 + Globals->UNDERWORLD_LEVELS + Globals->UNDERDEEP_LEVELS + Globals->ABYSS_LEVEL + Globals->SPIRIT_LEVEL);
  ...
  //regions.CreateSpiritLevel(Globals->UNDERWORLD_LEVELS + Globals->UNDERDEEP_LEVELS + 2 + Globals->ABYSS_LEVEL, 16, 16, "spirit");
