...
void Game::EditGameUnitDetails(Unit *pUnit)
{
  do {
    ...
    case U_APPRENTICE:
      ...
      //BUSHIDO addons
    case U_BUSHIDO_SAMURAI:
      temp = AString(" (samurai)");
      break;		        
    case U_BUSHIDO_KUGE:
      temp = AString(" (kuge)");
      break;		        
    case U_BUSHIDO_MERCHANT:
      temp = AString(" (merchant)");
      break;		        
    case U_BUSHIDO_ARTISAN:
      temp = AString(" (artisan)");
      break;		        
    case U_BUSHIDO_NINJA:
      temp = AString(" (ninja)");
      break;		        
    case U_BUSHIDO_GEISHA:
      temp = AString(" (geisha)");
      break;		        
    case U_BUSHIDO_PRIEST:
      temp = AString(" (priest)");
      break;		        
    case U_BUSHIDO_SORCEROR:
      temp = AString(" (sorceror)");
      break;		        
    }
